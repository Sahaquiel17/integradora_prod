    ...
    obj.forEach(function(elemento, indexElemento) {
        ...
        elemento.productos.forEach(function(producto, indexProducto) {
            ...
            registro += '<div class="producto" onclick="selectPlatillo(' + indexElemento + ', ' + indexProducto + ')">' +
                        ...
                        '</div>' +
                        '</div>'+
                        '<button class="btn btn-danger" onclick="eliminarPlatillo(' + indexElemento + ', ' + indexProducto + ');">Eliminar Producto</button>'
                 +'<br><br>';
       });
        ...
        registro += '<div class="codigo-qr" id="codigo_' + indexElemento + '">' +
                    ...
                    '<br><br>' +
                    '<button class="btn btn-outline-success" id="btndescargar_' + indexElemento + '">Descargar QR</button>' +
                    '<br><br>' +      
                    '<p>Horario: ' + hd + '</p>' +
                    '<p>Total de productos: ' + tp + '</p>' +
                    '<p>IVA: ' + IVA + '</p>' +
                    '<p>Total a pagar: ' + tpp + '</p>' +
                    '<button class="btn btn-danger"  onclick="eliminarTicket(' + indexElemento +');">Cancelar</button>&nbsp;&nbsp;' +
                    '<br><br>' +
                    '</div>';
